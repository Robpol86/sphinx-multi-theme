...
def modify_forked_sphinx_app(app: Sphinx, subdir: str):
    ...
    common_prefix = os.path.dirname(os.path.commonprefix([old_outdir, new_outdir]))
    ...
    common_prefix = os.path.dirname(os.path.commonprefix([old_doctreedir, new_doctreedir]))
